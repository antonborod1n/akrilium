...
class ItcSlider {
    ...
    static #ARK_SLIDER_ACTIVE = 'ark-slider__counter--active'
    static #ARK_SLIDER_COUNT = 'ark-slider__counter--count'
    ...
    constructor(el, config = {}, prefix = 'itc-slider__') {
        this.#state = {
            ...
            arkSliderActive: el.querySelector('.ark-slider__counter--active'), // элемент, текущий слайд
            arkSliderCount: el.querySelector('.ark-slider__counter--count'), // элемент, всего слайдов
    ...
    #updateClasses() {
        ...
        this.#state.arkSliderActive.textContent =
            this.#state.activeItems.indexOf(1) + 1
        this.#state.arkSliderCount.textContent = this.#state.activeItems.length
    }
    ...
    #init() {
        ...
        this.#state.width =
            this.#state.elListItem[0].getBoundingClientRect().width
        // ширина #EL_WRAPPER
